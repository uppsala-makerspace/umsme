...
/**
 * Colored tag showing a group's type, shared by the groups list, the workshop
 * page and a group's own page. The colors deliberately avoid green and amber,
 * which the membership chips (member/responsible and pending) use.
 */
const tags = {
  ...
  responsibility: { labelKey: "groupTypeResponsibility", classes: "bg-blue-100 text-blue-800" },
};

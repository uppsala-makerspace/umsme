      ...
      if (err) {
        ...
        if (res === "PAID") {
          Meteor.call(
            "addMembership",
            {
              mid: member_Id, // this ID connects member to membership
              amount: 1200,
              start: new Date(),
              ...
              if (err) {
                ...
                Meteor.call(
                  "addPayment",
                  {
                    ...
                    name: "should be name",
                    mobile: "0701234567",
                    member: member_Id, // this ID connects payment to member
                  ...
                  (err, paymentData) => {
                    if (err) {
                      ...
                      console.log("✅ Betalning tillagd med ID:", paymentData);

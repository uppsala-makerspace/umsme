  ...
  return (
    <div>
      ...
      <div className="AgreementHolder">
        ...
        <h1>Ansvarsförbindelse</h1>
        <h2>{membership.name}</h2>
        <p>{membership.description}</p>
        <h3>{membership.price} / år</h3>
        <p>
          Alla våra medlemmar behöver ta del av och signera vår
          ansvarsförbindelse.
        </p>
        <button
        ...
        <div>
          ...
          <label htmlFor="agreement">
            Jag har läst och håller med om det som står i ansvarsförbindelsen.
          </label>
        </div>
        <button
          ...
          <div className="MembershipAgreementModal">
            <div className="AgreementContent" onScroll={handleScroll}>
              ...
              <p>
                ...
                Detta är texten för ansvarsförbindelsen. Scrolla till botten för
                att godkänna.
              </p>
              <p style={{ marginTop: "1000px" }}>
                Detta är slutet av ansvarsförbindelsen.
              </p>

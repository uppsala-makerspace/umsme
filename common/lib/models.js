...
export const models = {
  ...
  storageUnit: {
    ...
    "warning.warned_by": { label: "Warned by", type: String, max: 100 },
    "warning.deadline_at": { label: "Warning deadline", type: Date },
    "warning.reminded_at": { label: "Reminder sent", type: Date, optional: true },
    "warning.message_id": { label: "Warning message", type: String, max: 250, optional: true },
    exemption: { label: "Exemption", type: Object, optional: true },
    "exemption.reason": { label: "Exemption reason", type: String, max: 5000 },
    "exemption.exempt_until": { label: "Exempt until", type: Date, optional: true },
    "exemption.created_at": { label: "Exemption created", type: Date },
    "exemption.created_by": { label: "Exemption created by", type: String, max: 100 },
    note: { label: "Internal note", type: String, max: 5000, optional: true },
    createdAt: { label: "Created", type: Date },
    updatedAt: { label: "Updated", type: Date },
  },
  ...
  storageOffer: {
    ...
    offered_at: { label: "Offered", type: Date },
    offered_by: { label: "Offered by", type: String, max: 100 },
  ...
  storageEvent: {
    ...
    member: { label: "Member", type: String, max: 50, optional: true },
    unit: { label: "Storage unit", type: String, max: 100, optional: true },
    related_unit: { label: "Related storage unit", type: String, max: 100, optional: true },

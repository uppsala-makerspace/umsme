...
export const models = {
  ...
  storageRequest: {
    owner: { label: "Owner", type: String, max: 50 },
    request_type: {
      label: "Request type",
      type: String,
      allowedValues: ["allocation", "move", "release"],
    },
    requested_at: { label: "Requested", type: Date },
    preference: { label: "Preference", type: Object, optional: true },
    "preference.floor": {
    ...
    fulfilled_at: { label: "Fulfilled", type: Date, optional: true },
    cancelled_at: { label: "Cancelled", type: Date, optional: true },
    createdAt: { label: "Created", type: Date },
    updatedAt: { label: "Updated", type: Date },
  },
  storageAssignment: {
    unit: { label: "Storage unit", type: String, max: 100 },
    owner: { label: "Owner", type: String, max: 50 },
    // Optional for legacy and direct manual assignments.
    request: { label: "Request", type: String, max: 100, optional: true },
    assigned_at: { label: "Assigned", type: Date },
    assigned_by: { label: "Assigned by", type: String, max: 100 },
    ended_at: { label: "Ended", type: Date, optional: true },
    ended_by: { label: "Ended by", type: String, max: 100, optional: true },
    ended_reason: {
      label: "End reason",
      type: String,
      allowedValues: ["moved", "voluntary_release", "reclaimed", "correction"],
      optional: true,
    },
    createdAt: { label: "Created", type: Date },
    updatedAt: { label: "Updated", type: Date },
  ...
  storageWarning: {
    assignment: { label: "Assignment", type: String, max: 100 },
    owner: { label: "Owner", type: String, max: 50 },
    warned_at: { label: "Warned", type: Date },
    warned_by: { label: "Warned by", type: String, max: 100 },
    deadline_at: { label: "Deadline", type: Date },
    warning_status: {
      label: "Warning status",
      type: String,
      allowedValues: ["open", "resolved_renewal", "resolved_reclamation", "voided"],
    },
    resolved_at: { label: "Resolved", type: Date, optional: true },
    resolved_by: { label: "Resolved by", type: String, max: 100, optional: true },
    createdAt: { label: "Created", type: Date },
    updatedAt: { label: "Updated", type: Date },
  },
  storageExemption: {
    assignment: { label: "Assignment", type: String, max: 100 },
    reason: { label: "Reason", type: String, max: 5000 },
    exempt_until: { label: "Exempt until", type: Date, optional: true },
    // Materialized current state. Expiry/revocation reconciliation clears it
    // before another exemption may be created for the assignment.
    active: { label: "Active", type: Boolean, defaultValue: true },
    created_at: { label: "Created", type: Date },
    created_by: { label: "Created by", type: String, max: 100 },
    revoked_at: { label: "Revoked", type: Date, optional: true },
    revoked_by: { label: "Revoked by", type: String, max: 100, optional: true },
    updatedAt: { label: "Updated", type: Date },
  },
  storageMove: {
    owner: { label: "Owner", type: String, max: 50 },
    request: { label: "Request", type: String, max: 100 },
    from_assignment: { label: "Source assignment", type: String, max: 100 },
    from_unit: { label: "Source unit", type: String, max: 100 },
    to_unit: { label: "Destination unit", type: String, max: 100 },
    reserved_at: { label: "Reserved", type: Date },
    reserved_by: { label: "Reserved by", type: String, max: 100 },
    deadline_at: { label: "Deadline", type: Date },
    requires_inspection: { label: "Requires inspection", type: Boolean, defaultValue: false },
    move_status: {
      label: "Move status",
      type: String,
      allowedValues: ["pending", "completed", "cancelled"],
    },
    completed_at: { label: "Completed", type: Date, optional: true },
    completed_by: { label: "Completed by", type: String, max: 100, optional: true },
    completed_by_type: {
      label: "Completion actor type",
      type: String,
      allowedValues: ["member", "administrator"],
      optional: true,
    },
    cancelled_at: { label: "Cancelled", type: Date, optional: true },
    cancelled_by: { label: "Cancelled by", type: String, max: 100, optional: true },
    cancellation_reason: { label: "Cancellation reason", type: String, max: 5000, optional: true },
    createdAt: { label: "Created", type: Date },
    updatedAt: { label: "Updated", type: Date },
  },
  storageNotificationDelivery: {
    owner: { label: "Owner", type: String, max: 50 },
    decision_type: {
      label: "Decision type",
      type: String,
    ...
    decision_id: { label: "Decision", type: String, max: 200 },
    recipient_email: { label: "Recipient email", type: String, max: 320, optional: true },
    recipient_mobile: { label: "Recipient mobile", type: String, max: 50, optional: true },
    render_status: {
      label: "Render status",
      type: String,
      allowedValues: ["rendered", "missing_template", "render_failed"],
    },
    render_error: { label: "Render error", type: String, max: 5000, optional: true },
    render_context: { label: "Render context", type: Object, blackbox: true, optional: true },
    sender_from: { label: "Sender", type: String, max: 320, optional: true },
    reply_to: { label: "Reply to", type: String, max: 320, optional: true },
    template_id: { label: "Template", type: String, max: 100, optional: true },
    message_id: { label: "Message", type: String, max: 100, optional: true },
    rendered_subject: { label: "Rendered subject", type: String, max: 200, optional: true },
    rendered_email: { label: "Rendered email", type: String, max: 10000, optional: true },
    rendered_sms: { label: "Rendered SMS", type: String, max: 2000, optional: true },
    email: { label: "Email delivery", type: Object },
    "email.status": {
      label: "Email status",
      type: String,
      allowedValues: ["pending", "sending", "sent", "failed", "unavailable"],
    },
    "email.attempts": { label: "Email attempts", type: Number, min: 0 },
    "email.last_attempt_at": { label: "Email last attempt", type: Date, optional: true },
    "email.lease_expires_at": { label: "Email lease expiry", type: Date, optional: true },
    "email.claim_token": { label: "Email claim token", type: String, max: 100, optional: true },
    "email.sent_at": { label: "Email sent", type: Date, optional: true },
    "email.last_error": { label: "Email error", type: String, max: 5000, optional: true },
    sms: { label: "SMS delivery", type: Object },
    "sms.status": {
      label: "SMS status",
      type: String,
      allowedValues: ["pending", "sending", "sent", "failed", "unavailable"],
    },
    "sms.attempts": { label: "SMS attempts", type: Number, min: 0 },
    "sms.last_attempt_at": { label: "SMS last attempt", type: Date, optional: true },
    "sms.lease_expires_at": { label: "SMS lease expiry", type: Date, optional: true },
    "sms.claim_token": { label: "SMS claim token", type: String, max: 100, optional: true },
    "sms.sent_at": { label: "SMS sent", type: Date, optional: true },
    "sms.last_error": { label: "SMS error", type: String, max: 5000, optional: true },
    "sms.provider_id": { label: "SMS provider id", type: String, max: 500, optional: true },
    created_at: { label: "Created", type: Date },
    created_by: { label: "Created by", type: String, max: 100 },
    updatedAt: { label: "Updated", type: Date },
  },
  storageEvent: {
    entity_type: { label: "Entity type", type: String, max: 100 },
    entity_id: { label: "Entity", type: String, max: 200 },
    event_type: { label: "Event type", type: String, max: 100 },
    actor_type: {
      label: "Actor type",
      type: String,
      allowedValues: ["member", "administrator", "system"],
    },
    actor: { label: "Actor", type: String, max: 100, optional: true },
    occurred_at: { label: "Occurred", type: Date },
    reason: { label: "Reason", type: String, max: 5000, optional: true },
    details: { label: "Details", type: Object, blackbox: true, optional: true },
  },
  storageActionExecution: {
    command_id: { label: "Command", type: String, max: 100 },
    suggestion_id: { label: "Suggestion", type: String, max: 250 },
    action_type: {
      label: "Action type",
      type: String,
      allowedValues: [
    ...
    target_type: { label: "Target type", type: String, max: 100 },
    target_id: { label: "Target", type: String, max: 200 },
    execution_status: {
      label: "Execution status",
      type: String,
      allowedValues: ["processing", "completed", "failed"],
    },
    attempts: { label: "Attempts", type: Number, min: 0 },
    claimed_at: { label: "Claimed", type: Date, optional: true },
    claim_token: { label: "Claim token", type: String, max: 100, optional: true },
    lease_expires_at: { label: "Lease expiry", type: Date, optional: true },
    completed_at: { label: "Completed", type: Date, optional: true },
    last_error: { label: "Last error", type: String, max: 5000, optional: true },
    result: { label: "Result", type: Object, blackbox: true, optional: true },
    operation_kind: { label: "Operation kind", type: String, max: 100, optional: true },
    payload_hash: { label: "Payload hash", type: String, max: 64, optional: true },
    caller_intent_hash: { label: "Caller intent hash", type: String, max: 64, optional: true },
    operation_payload: { label: "Operation payload", type: Object, blackbox: true, optional: true },
    completed_steps: { label: "Completed steps", type: Array, optional: true },
    "completed_steps.$": { label: "Completed step", type: String, max: 100 },
    created_by: { label: "Created by", type: String, max: 100 },
    createdAt: { label: "Created", type: Date },
    updatedAt: { label: "Updated", type: Date },
  },

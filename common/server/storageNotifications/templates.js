...
const templates = {
  assignment: (c) => ({
    ...
    sms: bilingual(
      `Uppsala Makerspace: Du har tilldelats hyllplats${unit(c)}. Se ditt mejl för mer information.`,
      `Uppsala Makerspace: You have been assigned storage unit${unit(c)}. See your email for more information.`,
      ' — ',
    ),
  }),
  move: (c) => ({
    ...
    sms: bilingual(
      `Uppsala Makerspace: Ny hyllplats${unit(c)} är reserverad.${deadline(c) ? ` Flytta senast ${deadline(c)}.` : ''}`,
      `Uppsala Makerspace: New storage unit${unit(c)} is reserved.${deadline(c, 'en-GB') ? ` Move no later than ${deadline(c, 'en-GB')}.` : ''}`,
      ' — ',
    ),
  }),
  warning: (c) => ({
    ...
    sms: bilingual(
      `Uppsala Makerspace: Förnya ditt labbmedlemskap eller töm hyllplatsen${deadline(c) ? ` senast ${deadline(c)}` : ''}.`,
      `Uppsala Makerspace: Renew your lab membership or empty your storage unit${deadline(c, 'en-GB') ? ` no later than ${deadline(c, 'en-GB')}` : ''}.`,
      ' — ',
    ),
  }),
  reminder: (c) => ({
    ...
    sms: bilingual(
      `Uppsala Makerspace: Påminnelse – förnya labbmedlemskapet eller töm hyllplatsen${deadline(c) ? ` senast ${deadline(c)}` : ''}.`,
      `Uppsala Makerspace: Reminder — renew your lab membership or empty your storage unit${deadline(c, 'en-GB') ? ` no later than ${deadline(c, 'en-GB')}` : ''}.`,
      ' — ',
    ),
  }),
  reclamation: (c) => ({
    ...
    sms: bilingual(
      `Uppsala Makerspace: Din hyllplats${unit(c)} har markerats för tömning. Se ditt mejl.`,
      `Uppsala Makerspace: Your storage unit${unit(c)} has been marked for clearance. See your email.`,
      ' — ',
    ),
  }),
  voluntary_release: (c) => ({
    ...
    sms: bilingual(
      `Uppsala Makerspace: Din hyllplats${unit(c)} är markerad som återlämnad. Tack!`,
      `Uppsala Makerspace: Your storage unit${unit(c)} is marked as returned. Thank you!`,
      ' — ',
    ),
  }),
};

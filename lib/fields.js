...
const filter = (fields, keys) => fields.filter(field => keys.indexOf(field.data) === -1);
...
//  member: extractor(models.member, memberDefaults),
  ...
  mail: extractor(models.mail, mailDefaults),

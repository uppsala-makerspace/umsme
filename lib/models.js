...
export const models = {
  member: {
    ...
    storagequeue: {label: 'In queue for storage', type: Boolean, max: 10, optional: true},
  ...
  message: {
    ...
    sms: {label: 'SMS (140 characters)', type: String, max: 140, optional: true,
      autoform: {
        type: 'textarea',
      }},
  },
  mail: {
    ...
    failed: {label: 'Failed', type: Array, optional: true, autoform: { type: 'recipients' } },
  ...
  lockusers: {
    ...
    email: {label: 'Email', type: String, max: 80, autoform: { readonly: true }, optional: true},
    lockid: {label: 'User id', type: String, max: 40, autoform: { omit: true }, optional: true},
    lockusername: {label: 'Username', type: String, max: 80, autoform: { readonly: true }, optional: true },
  ...
  users: {
    ...
    'emails.$.address': {label: 'Mail', type: String, max: 80, optional: true},
